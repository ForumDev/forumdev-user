...
from fduser.forms import LoginForm, UserRegistrationForm, LostPasswordForm, LostPasswordChangeForm, UserChangeForm
from fduser.models import Registration, User


class ProfileView(UpdateView):
 
  template_name = 'fduser/profile.html'
...
class RegisterView(FormView):
  ...
  template_name = 'fduser/register.html'
...
class EmailSentView(TemplateView):
  ...
  template_name = 'fduser/email_sent.html'
...
class LoginView(FormView):
  ...
  template_name = 'fduser/login.html'
...
class LostPasswordView(FormView):
  ...
  template_name = 'fduser/lost_password.html'
...
class LostPasswordEmailSentView(TemplateView):
  ...
  template_name = 'fduser/lost_password_email_sent.html'


class LostPasswordChangeView(FormView):
 
  template_name = 'fduser/lost_password_change.html'
